...
const HomePage = () => {
  const { getAllProblems, problems, isProblemsLoading,deleteProblemById } = useProblemStore();
  ...
  return (
    <>
      ...
      {
        problems.length > 0 ? <ProblemTable problems={problems} getAllProblems={getAllProblems} deleteProblemById={deleteProblemById}/> : (
